...
class CreateFridgeNewUser extends StatefulWidget {
  const CreateFridgeNewUser({super.key});

  @override
  State<CreateFridgeNewUser> createState() => _CreateFridgeNewUserState();
}

class _CreateFridgeNewUserState extends State<CreateFridgeNewUser> {
