...
class _FruitScreenState extends State<FruitScreen> {
  ...
  List<Items> fvlist = [];
  Future<List<Items>> fruitvegetableapi() async {
    final response = await http
        .get(Uri.parse('$ip/item/AllFruitsandVegetables?fid=$fridgeid'));
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Search For Fruit and Vegetable',
      ...
      body: SizedBox(
        ...
        child: Column(
          children: [
            ...
            const Text(
              'Select the fruits and vegetables you have at home',
                            ...
                            return SizedBox(
                              ...
                              child: ListTile(
                                leading:
                                    //  Ink.image(
                                    //   image: NetworkImage(
                                    //     itemimgpath + snapshot.data![index].image!,
                                    //   ),
                                    //   height: 100,
                                    //   width: 100,
                                    //   fit: BoxFit.fill,
                                  ...
                                  placeholder: (context, url) => Container(
                                    ...
                                    child:
                                        Image.asset('assets/fruitandvege.png'),
                                  ),
