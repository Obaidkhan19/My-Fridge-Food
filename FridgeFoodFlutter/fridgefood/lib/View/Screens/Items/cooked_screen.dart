...
class _CookedScreenState extends State<CookedScreen> {
  ...
  List<Items> clist = [];
  Future<List<Items>> cookedapi() async {
    final response = await http.get(Uri.parse('$ip/item/cooked?fid=$fridgeid'));
    var data = jsonDecode(response.body.toString());
    if (response.statusCode == 200) {
      clist.clear();
      // sucess
      for (Map i in data) {
        clist.add(Items.fromJson(i));
      }
      return clist;
    } else {
      return clist;
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Search For Cooked Items',
      ...
      body: SizedBox(
        ...
        child: Column(
          children: [
            ...
            const Text(
              'Select the Cooked Items you have at home',
                              ...
                              child: ListTile(
                                leading: CachedNetworkImage(
                                  ...
                                  placeholder: (context, url) => Container(
                                    ...
                                    child: Image.asset('assets/cooked.png'),
                                  ),
                                  errorWidget: (context, url, error) =>
                                      Image.asset('assets/cooked.png'),
                                ),
                                title: Text(
                                  itemname,
