...
class _DairyScreenState extends State<DairyScreen> {
  ...
  List<Items> dlist = [];
  Future<List<Items>> dairyapi() async {
    final response = await http.get(Uri.parse('$ip/item/Dairy?fid=$fridgeid'));
    var data = jsonDecode(response.body.toString());
    if (response.statusCode == 200) {
      dlist.clear();
      // sucess
      for (Map i in data) {
        dlist.add(Items.fromJson(i));
      }
      return dlist;
    } else {
      return dlist;
          ...
          child: Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Search For Dairy Items',
      ...
      body: SizedBox(
        ...
        child: Column(
          children: [
            ...
            const Text(
              'Select the Dairy Items you have at home',
